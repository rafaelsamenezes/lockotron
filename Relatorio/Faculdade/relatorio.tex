...
\section{Aplicativo Android}
    ...
    As figuras \ref{fig:android-controle}, \ref{fig:android-estatistica}, \ref{fig:android-navegacao} e \ref{fig:android-historico} mostram as telas do aplicativo.
    
    \begin{figure}[!h]
		\centering
		\includegraphics[width=.4\textwidth]{android1}
		\caption{Tela de Controle}
		\label{fig:android-controle}
	\end{figure}
	
	    \begin{figure}[!h]
		\centering
		\includegraphics[width=.5\textwidth]{android2}
		\caption{Tela de estatísticas}
		\label{fig:android-estatistica}
	\end{figure}
	
	    \begin{figure}[!h]
		\centering
		\includegraphics[width=.5\textwidth]{android3}
		\caption{Menu de navegação do aplicativo}
		\label{fig:android-navegacao}
	\end{figure}
	
	    \begin{figure}[!h]
		\centering
		\includegraphics[width=.5\textwidth]{android4}
		\caption{Tela de histórico}
		\label{fig:android-historico}
	\end{figure}
